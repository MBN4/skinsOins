          ...
          <div key={product.id} className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center min-h-[600px]">
            ...
            <div className={cn("space-y-8", idx % 2 !== 0 && "lg:order-1")}>
              ...
              <div className="flex items-center gap-8">
                ...
                <Link to={`/product/${product.id}`} className="group flex items-center gap-3 px-8 py-4 bg-slate-900 text-white rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-[#34495e] transition-colors shadow-lg">
